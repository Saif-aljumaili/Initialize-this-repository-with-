clear all
clc
header = blockEdfLoad('arif_burun_hareketi.edf');
    ...
    coun=coun+1;
     for  j=1:19
         ...
         x4=data4(k:k+249,j);
          ...
          r4=0.2*std(x4);
         apen = ApEn(2,r,x,1);
         apen1 = ApEn(2,r1,x1,1);
         apen2 = ApEn(2,r2,x2,1);
         apen3 = ApEn(2,r3,x3,1);
         apen4 = ApEn(2,r4,x4,1);
         DData(coun,5*(j-1)+1:5*j)=[apen apen1 apen2 apen3 apen4];
     end 
end 
xlswrite('h01_bandpass+shannon_Entropy.xlsx',[DData]);
